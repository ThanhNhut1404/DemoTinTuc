...
<head>
    ...
    <style>
        ...
        .flash{ background:#fff0f0;padding:6px 8px;border:none;color:#b91c1c;border-radius:6px;margin:8px auto 12px;max-width:100%;text-align:center;font-size:14px; font-weight:600 }
...
<script>
    ...
    // redirect to admin dashboard shortly after showing success
    setTimeout(function(){ window.location.href = 'admin.php?action=dashboard'; }, 1000);
    <?php endif; ?>
